...
color b
chcp 65001
title Adi Cheats Ultimate Optimizer
cls
mode con cols=52 lines=9
SET /P vinhauto= Key = 1 :
IF %vinhauto%==Face Goto MainMenu
cls
...
echo.                      
echo.                      
echo.                     Note: Due to Disclaimer, If In Case Your Device Has Error - CREATE A RECOVERY POINT BEFORE USING TOOLS, THANK YOU
echo.                     
echo.                   
echo.                                                                                                                                                 
echo.                                                                                                                                              
...
echo.              ╔══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
echo.              ║                                                                                                                                                      ║
echo.              ║ [ 1a ] Optimize (Pc)                             [ 1b ] High Performance                                 [ 1o ] Optimize FPS GAME                    ║
echo.              ║                                                                                                                                                      ║
echo.              ║ [ 2a ] Optimize (hard drive)                     [ 2b ] Turn off (Denfender)                             [ 2o ] Active Windows 10+11 Pro             ║
echo.              ║                                                                                                                                                      ║
echo.              ║ [ 3a ] Optimize (Internet)                       [ 3b ] Turn off (Windows Update)                        [ 3o  ]Create System Restore Restore Point  ║
echo.              ║                                                                                                                                                      ║
echo.              ║ [ 4a ] Optimize (GPU)                            [ 4b ] Turn off (Services) Unnecessary                  [ 4o ] CPU Optimization v2                  ║
echo.              ║                                                                                                                                                      ║
echo.              ║ [ 5a ] Optimize (Ram)                            [ 5b ] Turn off (Timer)                                 [ 5o ] Gpedit Optimization                  ║
echo.              ║                                                                                                                                                      ║
echo.              ║ [ 6a [ Optimize (regedit)                        [ 6b ] Turn off (Visual effects)                        [ 6o ] Speed up Windows laptop 10+11        ║
echo.              ║                                                                                                                                                      ║
echo.              ║ [ 7a ] Boost Fps                                 [ 7b ] Turn off (hyper-v)+( Tối Ưu Wifi)                [ 7o ] Laptop Recovery(6o)                  ║
echo.              ║                                                                                                                                                      ║
...
echo.              ║                                                                                                                                                      ║
echo.              ║ [ 10a] Clean all                                 [ 10b] exit                                             [ 10o] Ins Full Set of VISUL C++ 32/64bit   ║
echo.              ║                                                                                                                                                      ║
echo.              ║ -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  - ║
echo.              ║                                                                                                                                                      ║
echo.              ║          [  1x  ] Turn on the Printer                                  [  2x  ] Bật GameBar                       [  3x  ] Turn off the Printer      ║
echo.              ║                                                                                                                                                      ║
echo.              ║          [  4x  ] Turn off WMI Reverse Performance                                                       [  5x  ] Turn on WMI Reverse Performance    ║
echo.              ║                                                                                                                                                      ║
echo.              ║                                            [   6x   ] Install MemReduct (RAM Optimization and Cleanup App)                                           ║
echo.              ║                                                                                                                                                      ║
echo.              ║          [  7x  ] Reset Windows Explorer                  [  8x  ] Turn off GameBar                      [  9x  ]   Restore FPS GAME to default      ║
echo.              ║                                                                                                                                                      ║
echo.              ║:====================================================================================================================================================:║
echo.              ║:                    [ 1 ] Go to menu (Eliminate All)                                                                                                 ║
echo.              ║:                                                                                                                                                    :║
echo.              ║:                    [ 3 ] Go to menu (Regedit)                                             [ 4 ] Go to menu (Optimize Windows 10)                   :║
echo.              ║:                                                                                                                                                    :║
echo.              ║:                                                                                                                                                    :║
echo.              ║:                                                    [ 5 ] Go to menu Turn back on what was turned off                                               :║
echo.              ╚══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╝
echo.
SET /P Ryo2.0=   Please Select the Service You Want to Use:
IF %Ryo2.0%==1 GOTO Ryo1
IF %Ryo2.0%==2 GOTO Ryo2
IF %Ryo2.0%==3 GOTO Ryo3
IF %Ryo2.0%==4 GOTO Ryo5
IF %Ryo2.0%==5 GOTO Ryo4
IF %Ryo2.0%==11 GOTO Fixlag Regedit
IF %Ryo2.0%==1a GOTO Ryo1a
IF %Ryo2.0%==2a GOTO Ryo2a
IF %Ryo2.0%==3a GOTO Ryo3a
IF %Ryo2.0%==4a GOTO Ryo4a
IF %Ryo2.0%==5a GOTO Ryo5a
IF %Ryo2.0%==6a GOTO Ryo6a
IF %Ryo2.0%==7a GOTO Ryo7a
IF %Ryo2.0%==8a GOTO Ryo8a
IF %Ryo2.0%==9a GOTO Ryo9a
IF %Ryo2.0%==10a GOTO Ryo10a
IF %Ryo2.0%==1b GOTO Ryo1b
IF %Ryo2.0%==2b GOTO Ryo2b
IF %Ryo2.0%==3b GOTO Ryo3b
IF %Ryo2.0%==4b GOTO Ryo4b
IF %Ryo2.0%==5b GOTO Ryo5b
IF %Ryo2.0%==6b GOTO Ryo6b
IF %Ryo2.0%==7b GOTO Ryo7b
IF %Ryo2.0%==8b GOTO Ryo8b
IF %Ryo2.0%==9b GOTO Ryo9b
IF %Ryo2.0%==10b GOTO Ryo10b
IF %Ryo2.0%==1o GOTO Ryo1o
IF %Ryo2.0%==2o GOTO Ryo2o
IF %Ryo2.0%==3o GOTO Ryo3o
IF %Ryo2.0%==4o GOTO Ryo4o
IF %Ryo2.0%==5o GOTO Ryo5o
IF %Ryo2.0%==6o GOTO Ryo6o
IF %Ryo2.0%==7o GOTO Ryo7o
IF %Ryo2.0%==8o GOTO Ryo8o
IF %Ryo2.0%==9o GOTO Ryo9o
IF %Ryo2.0%==10o GOTO Ryo10o
IF %Ryo2.0%==1x GOTO Ryo1x
IF %Ryo2.0%==2x GOTO Ryo2x
IF %Ryo2.0%==3x GOTO Ryo3x
IF %Ryo2.0%==4x GOTO Ryo4x
IF %Ryo2.0%==5x GOTO Ryo5x
IF %Ryo2.0%==6x GOTO Ryo6x
IF %Ryo2.0%==7x GOTO Ryo7x
IF %Ryo2.0%==8x GOTO Ryo8x
IF %Ryo2.0%==9x GOTO Ryo9x
IF %Ryo2.0%==10x GOTO Ryo10x
IF %Ryo2.0%==11x GOTO Ryo11x
cls
...
cls
echo.
echo.              !  Note When Repairing, You Should Create a System Restore to Restore  
echo.                                                                                                                                                                                             
echo.
...
echo.                                                                    ^|
echo.              [ 24 ] Back to Mainmemu                               ^|          [ x ] Exit
echo.
echo.
SET /P Ryo2.0= Please select the service you want to use :
IF %Ryo2.0%==1 Goto xoa1
IF %Ryo2.0%==2 Goto xoa2
IF %Ryo2.0%==3 Goto xoa3
IF %Ryo2.0%==4 Goto xoa4
IF %Ryo2.0%==5 Goto xoa5
IF %Ryo2.0%==6 Goto xoa6
IF %Ryo2.0%==7 Goto xoa7
IF %Ryo2.0%==8 Goto xoa8
IF %Ryo2.0%==9 Goto xoa9
IF %Ryo2.0%==10 Goto xoa10
IF %Ryo2.0%==11 Goto xoa11
IF %Ryo2.0%==12 Goto xoa12
IF %Ryo2.0%==13 Goto xoa13
IF %Ryo2.0%==14 Goto xoa14
IF %Ryo2.0%==15 Goto xoa15
IF %Ryo2.0%==16 Goto xoa16
IF %Ryo2.0%==17 Goto xoa17
IF %Ryo2.0%==18 Goto xoa18
IF %Ryo2.0%==19 Goto xoa19
IF %Ryo2.0%==20 Goto xoa20
IF %Ryo2.0%==21 Goto xoa21
IF %Ryo2.0%==22 Goto xoa22
IF %Ryo2.0%==24 Goto xoa24
IF %Ryo2.0%==x Goto Exit
...
chcp 65001
cls
echo. Eliminate Success ( Successful Delete ) !!
timeout 5
Goto Menu1
...
echo.                      ^|                                                                                      ^|
echo.                      ^|                                                                                      ^|
echo.                      ^|              16e: Restart                         17e: Back to Mainmemu              ^|
echo.                      ^|______________________________________________________________________________________^|
SET /P AREYOUSURE=SELECT:
IF %AREYOUSURE%==1e GOTO Ryo1e
IF %AREYOUSURE%==2e GOTO Ryo2e
IF %AREYOUSURE%==3e GOTO Ryo3e
IF %AREYOUSURE%==4e GOTO Ryo4e
IF %AREYOUSURE%==5e GOTO Ryo5e
IF %AREYOUSURE%==6e GOTO Ryo6e
IF %AREYOUSURE%==7e GOTO Ryo7e
IF %AREYOUSURE%==8e GOTO Ryo8e
IF %AREYOUSURE%==9e GOTO Ryo9e
IF %AREYOUSURE%==10e GOTO Ryo10e
IF %AREYOUSURE%==11e GOTO Ryo11e
IF %AREYOUSURE%==12e GOTO Ryo12e
IF %AREYOUSURE%==13e GOTO Ryo13e
IF %AREYOUSURE%==14e GOTO Ryo14e
IF %AREYOUSURE%==15e GOTO Ryo15e
IF %AREYOUSURE%==16e GOTO :Restart
IF %AREYOUSURE%==17e GOTO :Ryo17e
cls
...
cls
echo.
echo Windows will reboot after 30 seconds... Please Save your work.
shutdown /r /t 30
pause
exit
...
color 2
echo.   
echo.         Do you want to access Memu Fixrung?
echo.
pause
cls
goto :Memu2
...
for /f "tokens=2 delims==" %%a in ('wmic path Win32_OperatingSystem get BuildNumber /value') do (set WinBuild=%%a) >nul 2>&1
echo.                               
echo.               Welcome to the Automatic Repair Recovery Menu / Created by Adii Lag Fix :3    
echo.                               
echo.              Hầu Như Tất Cả Các Chức Năng Trong Đây Đều Là Khôi Phục Về Mặc Định Nha ( Beta v0.1 )     
echo                 .________________________________________________________________________.
echo.                ㅏ                                                                       ㅓ
Echo.                ㅏ [a] Restore Services               [j] Mở System Restore            ㅓ
Echo.                ㅏ                                                                       ㅓ
...
Echo.                ㅏ                                                                       ㅓ
Echo.                ㅏ [e] GPU Optimization Restore      -  [m] Restore Windows Effects      ㅓ
Echo.                ㅏ                                                                       ㅓ
Echo.                ㅏ [f] CPU Optimization Restore         [k] Tắt Ultimate Performance     ㅓ
Echo.                ㅏ                                                                       ㅓ
Echo.                ㅏ          [FixLag] Return to Computer Optimization Menu Lobby          ㅓ
Echo.                ㅏ_______________________________________________________________________ㅓ
Echo.
Echo. ======================================================================
SET /P AREYOUSURE=.              Which Function Do You Want To Use Above ? : 
...
echo.        l There is currently no Command to Optimize RAM Restore l
echo.        l Please Use System Restore To Restore                  l 
...
cls
echo.      
echo.    Bcdedit Restored Successfully :3
echo. 
echo.        Press Any Key To Continue....
echo.    
pause > nul
...
cls
echo.      
echo.    Wifi Restored Successfully :3
echo. 
echo.        Press Any Key To Continue....
echo.    
pause > nul
...
cls
echo.      
echo.    Reg Restored Successfully :3
echo. 
echo.        Press Any Key To Continue....
echo.    
pause > nul
...
cls
echo.
echo. Please Install Normally and Untick the Bing Bar Box and Continue Installation
echo. Press Any Key To Continue...
echo.
pause > nul
Goto Ryo4
...
cls
echo.
echo.      System Restore Opened.
echo.    If There Is An Error Report !!! That's because your computer has turned off System Restore or erased it with Windows Lite
echo. 
echo.        Press Any Key To Continue....
echo.       
pause > nul
...
cls
echo. 
echo. READ User Guide For Windows 7 to 11
echo
echo.   If you want to return to the menu, press any key...
echo.
pause > nul
Goto Ryo4
...
cls
echo.  
echo     Restore Successfully, Press Any Key To Continue...
echo.
pause
Goto Ryo4
...
cls
echo.
echo Đã Xong. Press Any Key To Continue...
echo.
pause > nul
Goto Ryo4
...
cls
echo.
echo Virtual Ram Deleted. Restart For Effect...
echo.
pause > nul
Goto Ryo4
...
#By adii Lag Fix
cls 
echo Thanks Because I didn't re-up
pause
exit
Goto Mainmemu
...
echo.
SET /P Ryo2.0=Please Select the Service You Want to Use:
IF %Ryo2.0%==1d GOTO Ryo1d
IF %Ryo2.0%==2d GOTO Ryo2d
IF %Ryo2.0%==3d GOTO Ryo3d
IF %Ryo2.0%==4d GOTO Ryo4d
IF %Ryo2.0%==5d GOTO Ryo5d
IF %Ryo2.0%==6d GOTO Ryo6d
IF %Ryo2.0%==7d GOTO Ryo7d
IF %Ryo2.0%==8d GOTO Ryo8d
IF %Ryo2.0%==9d GOTO Ryo9d
IF %Ryo2.0%==10d GOTO Ryo10d
IF %Ryo2.0%==11d GOTO Ryo11d
...
IF %AREYOUSURE%==1y GOTO Ryo1y
IF %AREYOUSURE%==2y GOTO Ryo2y
IF %AREYOUSURE%==3y GOTO Ryo3y
IF %AREYOUSURE%==4y GOTO Ryo4y
IF %AREYOUSURE%==5y GOTO Ryo5y
IF %AREYOUSURE%==6y GOTO Ryo6y
IF %AREYOUSURE%==7y GOTO Ryo7y
cls
:Ryo1y
cls
...
echo.              
SET /P Ryo2.0=Please Select the Service You Want to Use:
IF %Ryo2.0%==1r GOTO Ryo1r
IF %Ryo2.0%==2r GOTO Ryo2r
IF %Ryo2.0%==3r GOTO Ryo3r
IF %Ryo2.0%==4r GOTO Ryo4r
IF %Ryo2.0%==5r GOTO Ryo5r
IF %Ryo2.0%==6r GOTO fixlagram
IF %Ryo2.0%==7r GOTO Ryo7r
IF %Ryo2.0%==8r GOTO Ryo8r
...
echo                           ==============================
echo.
choice /C:QT /N /M "[T] Continue Delete [Q] Go Back : "
...
echo     ==================================================================================
echo.
choice /C:QT /N /M "[T] Continue( Continue ) [Q] Return( Return ) : "
        if %errorlevel%==1 Goto :Mainmemu
		cls
...
echo.
choice /C:QT /N /M "[T] Continue [Q] Go back : "
        if %errorlevel%==1 Goto:Mainmemu
                cls

@echo off
echo.
echo.    Are you sure you want to run reg?
echo.
pause
cls
GOTO REG
...
echo.
echo.            ==============================================================================
SET /P AREYOUSURE= Do You Want To Activate Windows 10 Pro Or Windows 11 Pro? ( 10 / 11 ) : 
echo.            ==============================================================================
...
cls
echo System Restore Restore Point Has Been Created !!!
...
echo.
echo   Press Any Key To Continue.
echo   If you want to restore this function to its original state, please select function 22
echo.   
pause
Goto Mainmemu
...
cls
echo.
echo Press Enter in the new window and continue to press in this window as well.
echo.
pause 
...
echo Microsoft Edge Has Been Uninstalled. Restart the Device to Take Effect
pause > nul
Goto Mainmemu
...
cls
echo.
echo Click Continue and Install Normally
echo    Press Any Key To Return To Menu Lobby...
echo.
pause > nul
Goto Mainmemu
...
cls
echo.
SET /P AREYOUSURE=Do You Want To See Instructions For Using Ram / MemReduct Optimization Software? (Y or N):
